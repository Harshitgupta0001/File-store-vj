...
AUTH_CHANNEL = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('AUTH_CHANNEL', '-1002431588251').split()] 
...
PICS = (environ.get('PICS', 'https://envs.sh/n45.jpg')).split() # Bot Start Picture
